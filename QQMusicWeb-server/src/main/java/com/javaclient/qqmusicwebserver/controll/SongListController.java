...
public class SongListController {
    ...
    * */
     ...
     * 根据标题精确查询歌单列表
     */
    @RequestMapping(value = "/selectSongListOfTitle",method = RequestMethod.GET)
    public Object selectSongListOfTitle(HttpServletRequest request){
        String title = request.getParameter("title").trim();          //歌单标题
        return songListService.selectSongListOfTitle(title);
    }
    /**
     * 根据标题模糊查询歌单列表
     */
